...
function renderReport(result, opts = {}) {
  ...
  const title = `WCAG 2.1 AA Report — ${sourceLabel}`;
  ...
  const body = sortedViolations.length === 0
    ? `<div class="empty-pass">
         <h2>No automated WCAG 2.1 AA violations detected</h2>
...
<div class="container">
  ...
  <footer class="report-foot">
    ...
    Automated checks cover a subset of WCAG 2.1 AA — manual review still required for full conformance.
  </footer>
</div>
</body>
</html>`;
